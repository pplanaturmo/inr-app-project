...
public class DepartmentController {
    ...
    @Operation(summary = "Obtener usuarios pertenecientes al departamento", description = "Recuperar listado de usuarios pertenecientes al departamento a partir del ID de departañmento.", responses = {
    ...
    public List<User> getUsersByDepartmentId(
            @Parameter(description = "ID del departamento al que pertenecen los usuarios a buscar", required = true) @Valid @PathVariable("userId") @NotNull Long departmentId) {
